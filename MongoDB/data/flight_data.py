...
def generate_dataset(output_file, rows):
    with open(output_file, "w", newline='') as fd:
        fieldnames = ["airline", "from_airport" , "to_airport", "day", "month", "year","date", "duration", "age", "gender", "reason", "stay", "transit", "connection", "wait", "ticket", "checked_bags", "carry_on"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-r", "--rows",
            help="Amount of random generated entries for the dataset, defaults to: 100", type=int, default=10000)
